...
module.exports = class ModulesPreprocessor {
  ...
  getModulesTree() {
    if (!this._modulesTree) {
      let inputRoot = this.owner.belongsToAddon() ? this.owner.getParentAddonTree() : (this.owner.app.trees.app || this.owner.app.trees.src);
      let outputRoot = (this.owner.belongsToAddon() ? this.owner.getAddonModulesRoot() + this.owner.getOwnerName() : this.owner.app.trees.src ? (this.owner.getOwnerName() + '/src') : this.owner.getOwnerName());
